...
class RarityService:
    def __init__(self):
        self._rarities = [
            ...
            RarityEntity("trainer gallery rare holo", "Trainer Gallery Rare Holo", "rare_holo", tier=1),
            ...
            RarityEntity("trainer gallery rare holo v", "Trainer Gallery Rare Holo V", "rare_holo_v", tier=2),
            ...
            RarityEntity("trainer gallery rare ultra", "Trainer Gallery Rare Ultra", "rare_ultra", tier=3),
            ...
            RarityEntity("trainer gallery rare secret", "Trainer Gallery Rare Secret", "rare_secret", tier=4),
